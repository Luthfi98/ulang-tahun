...
$('document').ready(function(){
	...
	$('#turn_on').click(function(){
		...
		$(this).fadeOut('slow').delay(5000).promise().done(function(){
			...
			$('#play').fadeOut('slow').delay(6000).promise().done(function(){
				$('.bannar').addClass('bannar-come');
				$('#bannar_coming').fadeOut('slow').delay(6000).promise().done(function(){
					$('.balloon-border').animate({top:-500},8000);
					$('#b1,#b3,#b4,#b5,#b6').addClass('balloons-rotate-behaviour-one');
					$('#b2,#b7,#b8,#b9').addClass('balloons-rotate-behaviour-two');
					...
					$('#balloons_flying').fadeOut('slow').delay(5000).promise().done(function(){
	...
	$('#cake_fadein').click(function(){
		...
		$(this).fadeOut('slow').delay(3000).promise().done(function(){
			$('.fuego').fadeIn('slow');
			$('#light_candle').fadeOut('slow').delay(3000).promise().done(function(){
				 vw = $(window).width()/2;
				...
				$('#wish_message').fadeOut('slow').delay(5000).promise().done(function(){
					$('#story').fadeIn('slow');
				});
			});
		});
